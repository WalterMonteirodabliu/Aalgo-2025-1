...
import random  # Importa a biblioteca random para gerar listas aleatórias
...
# Lista de tamanhos para testar o tempo de execução
tamanhos = [100, 1_000, 10_000, 100_000]

# Executa os testes para cada tamanho de entrada e imprime o tempo de execução
for tamanho in tamanhos:
    tempo = medir_tempo_quick_sort(tamanho) 
